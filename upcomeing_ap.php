...
<body>
	...
	<div class="alert header-line" role="alert" style="  text-align: center;">
		<strong>User Upcomeing Appoinment List </strong>
	</div>
	<center>
	...
	<?php 
		...
		$sql = "SELECT * FROM `appoinment` WHERE pId='$sid' ORDER BY aId DESC";
